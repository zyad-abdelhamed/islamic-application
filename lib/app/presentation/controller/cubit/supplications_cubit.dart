...
class SupplicationsCubit extends Cubit<SupplicationsState> {
  ...
  SupplicationsCubit() : super(SupplicationsState());
  static SupplicationsCubit getSupplicationsController(BuildContext context) {
    final SupplicationsCubit controller = context.read<SupplicationsCubit>();
    return controller;
  }
