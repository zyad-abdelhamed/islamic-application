...
import 'package:test_app/features/app/presentation/view/pages/beautiful_names_of_allah_page.dart';
...
class RandomAllahNameCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AllahNamesCubit>(
      create: (_) => sl<AllahNamesCubit>()..init(),
        ...
        builder: (context, state) {
          if (state is GetRandomAllahName) {
            final List<AllahNameEntity> names =
                context.read<AllahNamesCubit>().names;
            return AnimatedSwitcher(
              ...
              child: GestureDetector(
                onTap: () => Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            BeautifulNamesOfAllahPage(names: names))),
                child: Container(
                        ...
                        children: [
                          ...
                          FavoriteButton<AllahNamesCubit, AllahNamesState>(
                            ...
                            listener: (ctx, state, runAnimation) {
                              ...
                              if (state
                                  is AllahNamesStateIsToggleFavoriteError) {
                                AppSnackBar(
