...
class AppColors {
  static const primaryColor = Color(0xFF1391A2);
  static  Color inActivePrimaryColor = Color.fromARGB(255, 156, 211, 218).withValues(alpha: .3);
  ...
  static const grey = Color(0xFFA49C9C);
  static const grey1 = Color.fromARGB(31, 168, 166, 166);
  static const grey2 = Color.fromARGB(31, 134, 133, 133);
}
